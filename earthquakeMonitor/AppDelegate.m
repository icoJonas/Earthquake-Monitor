...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self.window setRootViewController:[self createMainController]];
...
{
    earthquakeMonitorMainViewController *viewController=[[earthquakeMonitorMainViewController alloc] init];
