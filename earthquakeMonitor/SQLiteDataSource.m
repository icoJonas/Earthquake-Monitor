...
-(id)init
{
    ...
    if(self)
    {
        ...
        dbPath = [documentDir stringByAppendingPathComponent:@"EarthquakeMonitor.db"];
...
-(void) createAndCheckDatabase
{
    ...
    NSString *databasePathFromApp = [[[NSBundle mainBundle] resourcePath]
                                     stringByAppendingPathComponent:@"EarthquakeMonitor.db"];
    NSArray *documentPaths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *documentDir = [documentPaths objectAtIndex:0];
    NSString* destinationPath = [documentDir stringByAppendingPathComponent:@"EarthquakeMonitor.db"];
